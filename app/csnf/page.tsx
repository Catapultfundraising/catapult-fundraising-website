...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.catapultfr.com/csnf" },
};

// Placeholder until the interview scheduling link is created.
const SCHEDULING_LINK = "#schedule";
const SCHEDULING_LINK_READY = false;
const CONTACT_EMAIL = "amyw@catapultfr.com";
    ...
    <div className="bg-white font-sans text-[#1f2933]">
      ...
      <section className="border-b border-[#d8e3ef] bg-[#CFE0F2]">
        <div className="mx-auto max-w-5xl px-6 py-10">
          ...
          {!SCHEDULING_LINK_READY && (
            <p className="mt-3 text-xs font-semibold uppercase tracking-wide text-[#8a6d1f]">
              Placeholder: scheduling link to be added
            </p>
          )}
        </div>
      </section>
      ...
      <section className="mx-auto max-w-3xl px-6 py-14">
        <div className="space-y-5 text-base leading-relaxed">
          ...
          <p>
            ...
            Northwest Valley commute 35 to 40 minutes to the nearest campus,
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-7 flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-white/85">
              Or contact Amy C. Wiles, Chief Campaign Strategist, at{" "}
