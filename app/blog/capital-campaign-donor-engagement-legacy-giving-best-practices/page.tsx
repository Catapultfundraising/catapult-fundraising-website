  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-4xl px-6 py-14 lg:px-10 lg:py-16">
        <ShareButtons url={`/blog/capital-campaign-donor-engagement-legacy-giving-best-practices`} title="Capital Campaign, Mid-Level Donor Engagement & Legacy Giving Best Practices" />
