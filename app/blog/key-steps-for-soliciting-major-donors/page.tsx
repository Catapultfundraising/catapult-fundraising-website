...
const jsonLd = {
  ...
  description:
    "Diane Carlson's four-right rule for turning long-time supporters into major gift donors: the right person asking the right prospect for the right amount at the right time.",
  author: { "@type": "Person", name: "Diane Carlson", affiliation: "Catapult Fundraising" },
  publisher: {
    "@type": "Organization",
  ...
  return (
    <>
      ...
      <PageHero
        eyebrow="Insights"
        title="Key Steps for Soliciting Major Donors"
        description="Want to make more successful asks? Diane Carlson's “four-right rule”: the right person asking the right prospect for the right amount at the right time."
      />

      <article className="mx-auto max-w-4xl px-6 py-14 lg:px-10 lg:py-16">
        <p className="text-lg leading-relaxed text-[rgb(var(--ink))]/70">
          Want to make more successful asks? Use the &ldquo;four-right rule,&rdquo; advises Diane
          Carlson, chairman, Catapult Fundraising (Henderson, NV): the right person asking the
          right prospect for the right amount at the right time.
        </p>
        ...
        <blockquote className="mt-6 border-l-4 border-[rgb(var(--brass))] pl-6 font-display text-xl italic leading-snug text-[rgb(var(--navy))]">
          &ldquo;At most nonprofits, the weakest part of their fundraising is in managing the ask.
          It&rsquo;s important that all of those rights are considered when planning the
          ask.&rdquo;
        </blockquote>
        ...
        <ol className="mt-8 space-y-5 pl-5 list-decimal marker:font-display marker:font-semibold marker:text-[rgb(var(--brass))]">
          <li className="pl-2 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
            ...
            vary, Carlson says. Someone who knows the prospect may be a good choice, but
            &ldquo;not if they can&rsquo;t actually get to an ask over their lips.&rdquo; A good
            strategy is to send two emissaries to prospect meetings, so one can focus on body
            language while the other does most of the talking.
          </li>
          <li className="pl-2 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
            <span className="font-semibold text-[rgb(var(--navy))]">To find the right prospects</span>,
            perform a wealth-capacity screen. &ldquo;We&rsquo;re making sure the right prospect is
            somebody who has the wealth capacity to give the gift we&rsquo;re thinking of as well
            as the interest to give the gift.&rdquo;
          </li>
          <li className="pl-2 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
            <span className="font-semibold text-[rgb(var(--navy))]">Figure the right amount</span>{" "}
            for the ask before your first meeting, because some prospects will want to
            &ldquo;cut to the chase.&rdquo; Building on wealth-capacity screening from
            DonorSearch, Catapult&rsquo;s researchers perform an in-house review of about 30
            internet resources to learn about prospects&rsquo; capacities and interests.
          </li>
          <li className="pl-2 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
            <span className="font-semibold text-[rgb(var(--navy))]">The best time to make an ask</span>{" "}
            is usually during the second meeting. Use the first to educate and inform and get
            that second meeting. If the prospect brings new people like family members or
            financial advisors to the next meeting, you may have to fill them in and ask for a
            third meeting. It&rsquo;s usually a case of diminishing returns after that, however.
          </li>
        </ol>
        ...
        <p className="mt-8 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
          ...
          staff to gain confidence through role playing, Carlson adds.
        </p>
        ...
        <p className="mt-4 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
          ...
          wealthy long-time members of organizations say they have never made a major gift
          because they have never been asked. Just by belonging to your organization and agreeing
          to a meeting, top prospects are signaling they may be ready to make a major gift,
          Carlson notes.
        </p>

        <blockquote className="mt-6 border-l-4 border-[rgb(var(--brass))] pl-6 font-display text-xl italic leading-snug text-[rgb(var(--navy))]">
          &ldquo;We have these huge wealth-capacity people who have a very low to poor gift
          history. So then it&rsquo;s a matter of how do you take the $50 member and move them up
          to a $100,000 ask.&rdquo;
        </blockquote>
        ...
        <p className="mt-6 text-lg leading-relaxed text-[rgb(var(--ink))]/70">
          ...
          opportunity. &ldquo;I have rarely known donors who want to be anonymous,&rdquo; Carlson
          says. &ldquo;I find they hugely care about donor recognition.&rdquo;
        </p>
        ...
        <p className="mt-12 border-t border-[rgb(var(--line))] pt-6 text-sm text-[rgb(var(--ink))]/40">
          Source: Diane Carlson, Chairman, Catapult Fundraising, Henderson, NV. Originally
          published in The Major Gifts Report © 2019.
        </p>
      </article>
