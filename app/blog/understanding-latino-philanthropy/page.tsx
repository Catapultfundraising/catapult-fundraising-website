...
export const metadata = {
  title: "Understanding Latino Philanthropy",
  description:
    "Anthony Alonso on why 'Latinos don't give' is a myth, and how to frame a case for support that resonates with family and community.",
  keywords: [
    "Latino philanthropy",
  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-4xl px-6 py-14 lg:px-10 lg:py-16">
        <ShareButtons url={`/blog/understanding-latino-philanthropy`} title="Understanding Latino Philanthropy: Lessons for Nonprofit Fundraisers" />
