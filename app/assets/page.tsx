...
export const metadata = {
  ...
  description:
    "Internal hub for the Catapult Fundraising team: build your email signature, download brand fonts, logo files, letterhead, and social banners, grab print-ready one-sheets, get ready-to-post social media content, and download our virtual meeting background.",
  ...
  return (
    <>
      <PageHero
        ...
        description="Build your email signature, download brand fonts, logos, letterhead, and social banners, grab print-ready one-sheets, get ready-to-post social media content, and download your Teams/Zoom background, all from a single page."
      />
