...
export const metadata = {
  ...
  description:
    "Internal hub for the Catapult Fundraising team: build your email signature, download brand fonts, logo files, letterhead, and social banners, grab print-ready one-sheets, and get ready-to-post social media content.",
  ...
  return (
    <>
      <PageHero
        ...
        description="Build your email signature, download brand fonts, logos, letterhead, and social banners, grab print-ready one-sheets, and get ready-to-post social media content, all from a single page."
      />
