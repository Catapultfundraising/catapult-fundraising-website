...
export const metadata = {
  ...
  description:
    "Internal hub for the Catapult Fundraising team: build your email signature, generate a print-ready business card, download brand fonts, logo files, letterhead, and social banners, grab print-ready one-sheets, get ready-to-post social media content, and download our virtual meeting background.",
