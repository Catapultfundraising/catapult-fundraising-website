...
const ROUTE_LAST_MODIFIED: Record<string, string> = {
  ...
  "/resources/donor-loyalty-assessment": "2026-09-12",
  "/insights": "2026-08-29",
  ...
  "/blog": "2026-09-25",
  "/blog/new-charitable-deduction-2026-donor-conversation": "2026-09-25",
...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    "/results",
    "/resources",
    "/resources/gift-chart-calculator",
    "/resources/campaign-readiness-assessment",
    "/resources/donor-loyalty-assessment",
    "/services/capital-campaign",
    "/services/feasibility-study",
    "/services/capital-campaign/education",
    "/services/capital-campaign/churches",
    ...
    "/insights/case-studies/salvation-army-southern-nevada-capital-campaign",
    "/blog",
    "/blog/new-charitable-deduction-2026-donor-conversation",
    "/blog/planned-giving-loyalty-jeff-grandy-first-day-podcast",
    "/blog/lapsed-donor-reactivation-win-back-your-database",
    "/blog/why-people-give-trust-connection-moment-to-act",
