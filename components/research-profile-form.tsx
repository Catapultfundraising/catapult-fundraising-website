  ...
  async function handleImportPdf(file: File) {
    ...
    try {
      ...
      setData((d) => ({
        ...
        spouseName: d.spouseName || extracted.spouseName,
        parentsNames: d.parentsNames || extracted.parentsNames,
        hobbiesInterests: d.hobbiesInterests || extracted.hobbiesInterests,
        ...
        estimatedLiquidity: d.estimatedLiquidity || extracted.estimatedLiquidity,
        liquidityExplanation: d.liquidityExplanation || extracted.liquidityExplanation,
        ...
        otherAssets: d.otherAssets.length ? d.otherAssets : extracted.otherAssets ?? d.otherAssets,
