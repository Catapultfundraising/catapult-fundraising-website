    ...
    <div className="mt-16 space-y-6">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <ResourceCard
          ...
          description="The official cover banner for our LinkedIn company page and Facebook page: the Catapult logo in its true colors, centered on a tan background matching the website header. Upload the same image to both for a consistent look."
          links={[
            {
